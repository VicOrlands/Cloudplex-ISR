...
export const testimonials: {
  ...
  {
    content:
      "Since having our workloads on AWS, the ability to be flexible with server provisioning has been second to none. It has improved our time to market by 60% and given us more cost control over our infrastructure thanks to CloudPlexo.",
