...
import "./AWSWellArchitected.css";
import { pillars, reviews } from "./Arrays";
import HeroImage from "../../../assets/images/well-architected/aws-well-architected-framework-hero.svg";
import CustomerCareImage from "../../../assets/images/well-architected/aws-well-architected-framework-customer-care.png";
...
export default function AWSWellArchitected() {
  return (
    <React.Fragment>
      ...
      />
      <div className="aws-partnership-parent">
      ...
      Well-Architected Framework"
        ...
        <section className="well-architected-review-matters">
          ...
          <div>
            ...
            <section className="pillars-of-well-architected-framework">
              {pillars.map((pillar) => (
        ...
        <section className="well-architected-reviews">
          <h2>
          ...
          {reviews.map((review, index) => (
            <div className="framework-review" key={review.title}>
              <h3>
        ...
        <section className="well-architected-form">
          <div className="form">
            <h2>
