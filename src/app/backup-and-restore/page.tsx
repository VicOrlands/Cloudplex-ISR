...
export const metadata: Metadata = {
  ...
  description:
    "Discover CloudPlexo's Backup and Recovery solutions to safeguard your data from ransomware and ensure secure data backup and recovery.",
  keywords: [
    "Data backup",
  ...
  alternates: {
    canonical: "https://www.cloudplexo.com/backup-and-restore",
  },
};

const logos = [AWSLogo, GoogleLogo, AzureLogo, Veeam, BdrLogo];
      ...
      <LazyBackgroundImage src={BgImg} className={styles["bg-backup"]}>
        <section className={styles["backup-hero"]}>
          <div>
            ...
            <ul>
              <li>
                <Icon /> Cloud Backup & Recover
              </li>
              <li>
                <Icon /> Virtual Machine Backup & Recovery
              </li>
              <li>
                <Icon /> Application Backup & Recovery
              </li>
              <li>
                <Icon /> Endpoint backup & Recovery
              </li>
              <li>
                <Icon /> Server backup & Recovery
              </li>
            </ul>
      ...
      <section className={styles["modules"]}>
        ...
        <section className={styles["footer"]}>
          <div>
            ...
            <p>
              Secure your data with a reliable backup solution. Take the first
              step towards peace of mind, knowing your business is protected
              with our cloud backup and restore services.
            </p>
            <ButtonLink
              title="Get Started"
              link="/contact-us"
          ...
          <Image src={footer} alt="CloudPlexo Backup & Recovery Solutions" />
        </section>
      </section>
    </div>
  );
