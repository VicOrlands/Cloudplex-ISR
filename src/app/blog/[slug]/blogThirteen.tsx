...
import blog1 from "../../../assets/images/blog/blog.webp";
                  ...
                  <div className="col-md-10">
                    {/* <ul className="list-unstyled d-flex justify-content-between mt-4">
											<li className="list-inline-item user mr-2">
												<Link to="#">
													<i className="mdi mdi-account text-dark" /> Omotola Dorcas
												</Link>
											</li>
											<li className="list-inline-item date text-muted">
												<i className="mdi mdi-calendar-check text-dark" /> 15th July, 2022
											</li>
										</ul> */}
                    ...
                    <p>
                      ...
                      <br />
                      <a href="https://wendu.io">Wendu</a> by CloudPlexo - Cloud
