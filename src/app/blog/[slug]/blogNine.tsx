...
import blog1 from "../../../assets/images/rightsizing.jpeg";
              ...
              <Col lg={12} className="text-center">
                <div className="page-next-level">
                  <h4 className="title text-white title-dark">
                    {" "}
                    Rightsizing Recommendation - An Approach to Save on Your AWS
                    Cost{" "}
                  </h4>
                </div>
              </Col>
                  ...
                  <div className="col-md-10">
                    <ul className="list-unstyled d-flex justify-content-between mt-4">
                      ...
                      <li className="list-inline-item date text-muted">
                        <i className="mdi mdi-calendar-check text-dark"></i> 4
                        June, 2021
                      </li>
                    </ul>
