...
import blog1 from "../../../assets/images/work/27.jpg";
              ...
              <Col lg={10}>
                <Row>
                  ...
                  <div className="col-md-10">
                    ...
                    <br />
                    <br />
                    <span style={{ fontWeight: "800" }}>Keywords: </span>
                    ...
                    <p>
                      ...
                      <a href="https://cloudplexo.com/">Cloudplexo platform</a>{" "}
                    ...
                    <h5 className="mt-4">Resource Usage Monitoring</h5>
                    ...
                    <h5 className="mt-4">Operations Scheduling</h5>
                    ...
                    <h5 className="mt-4">Rightsizing recommendation</h5>
                    ...
                    <h5 className="mt-4">User-Friendly Data Representation</h5>
                    <p>
                    ...
                    <h5 className="mt-4">Multi-Cloud Support</h5>
                    <p>
