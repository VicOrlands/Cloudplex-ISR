...
import blog1 from "../../../assets/images/work/29.jpeg";
              ...
              <Col lg={12} className="text-center">
                <div className="page-next-level">
                  <h4 className="title text-white title-dark">
                    {" "}
                    Ways Companies Can Save On Their Cloud Computing Costs{" "}
                  </h4>
                </div>
              </Col>
            </Row>
              ...
              <Col lg={10}>
                <Row>
                  ...
                  <div className="col-md-10">
                    ...
                    <h5 className="mt-4">Rightsizing</h5>
                    ...
                    <h5 className="mt-4">Automation</h5>
                    ...
                    <h5 className="mt-4">Elastic Load Balancers(ELBs)</h5>
