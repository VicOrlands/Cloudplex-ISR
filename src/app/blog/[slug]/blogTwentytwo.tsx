...
import result from "../../../assets/images/blog/comprehend_job_result.png";
import analysis from "../../../assets/images/blog/comprehend_job_analysis.png";
              ...
              <Col lg={10}>
                <Row>
                  ...
                  <div className="col-md-10">
                    <h2>Hands on with AWS Comprehend</h2>
                    <h4>Introduction</h4>
                    <p>
                    ...
                    <ol>
                      ...
                      <br />
                      <img src={result} alt="result" className="img-fluid" />
                      <br />
                      <li>
                        <strong>
                          {" "}
