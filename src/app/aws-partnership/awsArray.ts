...
export const awsservices: AWSProps[] = [
  ...
  },
  {
    ...
    metadataConfig: {
      title: "AWS Cloud Migration Services | CloudPlexo Services",
      description:
        "As a leading cloud migration service provider, CloudPlexo delivers expert AWS migration solutions, including detailed readiness assessments by our cloud migration specialists.",
      keywords: [
        "cloud migration services aws",
      ...
      canonical: "https://www.cloudplexo.com/aws-partnership/cloud-migration",
    },
  },
  {
    img: Archictected,
